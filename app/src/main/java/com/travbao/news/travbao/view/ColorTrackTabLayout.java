package com.travbao.news.travbao.view;
...
public class ColorTrackTabLayout extends TabLayout {
    ...
    */
    ...
    public void setmTabTextColor(int mTabTextColor,int mTabSelectedTextColor) {
        this.mTabTextColor = mTabTextColor;
        this.mTabSelectedTextColor = mTabSelectedTextColor;
        invalidate();
    }
        ...
        if (attrs != null) {
            ...
            try {
                ...
                try {
                    ...
                    //Tab文字颜色
                    mTabTextColor = a.getColor(
                            android.support.design.R.styleable.TabLayout_tabTextColor, 0);
                } finally {
                    ta.recycle();
                }

                //Tab文字选中颜色
                mTabSelectedTextColor = a.getColor(android.support.design.R.styleable.TabLayout_tabSelectedTextColor, getResources().getColor(R.color.title_color));
